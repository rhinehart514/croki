...
- Version-skew guidance is directional. An older server may offer its advertised server-update path; an older client tells the founder to update Croki on that device and never offers a server rollback.
