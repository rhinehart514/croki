 ...
 */
import { IsoDateTime, ModelSelection, ProjectId, ProjectScript } from "@croki/contracts";
...
>()("croki-server/persistence/Services/ProjectionProjects/ProjectionProjectRepository") {}
