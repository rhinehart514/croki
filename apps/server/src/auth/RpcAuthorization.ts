...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.identityCurrent]: AuthOrchestrationReadScope,
  [WS_METHODS.identityRegister]: AuthOrchestrationOperateScope,
  [WS_METHODS.projectsEnsureOwner]: AuthOrchestrationOperateScope,
  [WS_METHODS.projectsCreateInvitation]: AuthOrchestrationOperateScope,
  [WS_METHODS.projectsAcceptInvitation]: AuthOrchestrationOperateScope,
  [WS_METHODS.projectsListMembers]: AuthOrchestrationReadScope,
  [WS_METHODS.projectsListInvitations]: AuthOrchestrationReadScope,
  [WS_METHODS.projectsRevokeInvitation]: AuthOrchestrationOperateScope,
  [WS_METHODS.projectsRemoveMember]: AuthOrchestrationOperateScope,
  [WS_METHODS.projectsTransferOwnership]: AuthOrchestrationOperateScope,
