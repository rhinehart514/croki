...
import type { VcsDriverKind, VcsError, VcsRepositoryIdentity } from "@croki/contracts";
import { VcsUnsupportedOperationError } from "@croki/contracts";
...
>()("croki-server/vcs/VcsDriverRegistry") {}
