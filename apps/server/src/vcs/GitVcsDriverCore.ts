...
import { dedupeRemoteBranchesWithLocalMatches, normalizeGitRemoteUrl } from "@croki/shared/git";
import { compactTraceAttributes } from "@croki/shared/observability";
...
> {
  ...
  const traceFilePath = yield* fs.makeTempFileScoped({
    prefix: `croki-git-trace2-${process.pid}-`,
    suffix: ".json",
  });
