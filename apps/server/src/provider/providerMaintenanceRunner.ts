...
>()("croki-server/provider/providerMaintenanceRunner") {}
            ...
            return yield* finish(
              makeUpdateState({
                ...
                message: couldNotVerify
                  ? "Update command completed, but Croki could not verify the provider version."
                  : stillOutdated
                    ? "Update command completed, but Croki still detects an outdated provider version."
                    : "Provider updated.",
                output: commandOutput(result),
              }),
            );
