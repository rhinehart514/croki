      ...
      Effect.provide(
        AcpSessionRuntime.layer({
          spawn: {
            ...
            args: mockAgentArgs,
            env: {
              CROKI_ACP_EMIT_INTERLEAVED_ASSISTANT_TOOL_CALLS: "1",
            },
          },
          cwd: process.cwd(),
          clientInfo: { name: "t3-test", version: "0.0.0" },
      ...
      Effect.provide(
        AcpSessionRuntime.layer({
          spawn: {
            ...
            args: mockAgentArgs,
            env: {
              CROKI_ACP_EMIT_GENERIC_TOOL_PLACEHOLDERS: "1",
            },
          },
          cwd: process.cwd(),
          clientInfo: { name: "t3-test", version: "0.0.0" },
      ...
      Effect.provide(
        AcpSessionRuntime.layer({
          ...
          spawn: {
            ...
            args: mockAgentArgs,
            env: {
              CROKI_ACP_HANG_LOAD_SESSION_AFTER_REPLAY: "1",
              CROKI_ACP_LOAD_SESSION_DELAY_MS: "10000",
            },
          },
          cwd: process.cwd(),
          resumeSessionId: "mock-session-1",
