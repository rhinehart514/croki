import { type GrokSettings, ProviderDriverKind } from "@croki/contracts";
...
const CROKI_CODE_OAUTH_REFERRER = "croki";
...
export function buildGrokAcpSpawnInput(
  ...
  return {
    ...
    env: {
      ...environment,
      [GROK_OAUTH2_REFERRER_ENV]: CROKI_CODE_OAUTH_REFERRER,
    },
  };
}
