...
import type { CursorSettings } from "@croki/contracts";
...
const cursorAcpDiscoveryFailedMessage = [
  ...
  "Cursor CLI setup may be incomplete; install or enable the Cursor CLI, restart Croki, and try again.",
...
const cursorCliCommandMissingMessage = [
  ...
  `Install or enable the Cursor CLI, make sure \`${missingCursorBinaryPath}\` is on PATH, then restart Croki.`,
  "See https://cursor.com/docs/cli/installation.",
].join(" ");
