    ...
    const provider = yield* makeProvider({
      getPullRequest: () =>
        Effect.succeed({
          ...
          headRepositoryNameWithOwner: "fork/croki",
...
it.effect("adds safe request context while retaining GitHub CLI causes", () =>
  Effect.gen(function* () {
    ...
    const error = yield* provider
      .getChangeRequest({
        cwd: "/repo",
        reference: "https://user:secret@github.com/rhinehart514/croki/pull/42?token=secret#diff",
      })
      .pipe(Effect.flip);
    ...
    assert.deepStrictEqual(
      ...
      },
      {
        ...
        command: "gh",
        cwd: "/repo",
        reference: "https://github.com/rhinehart514/croki/pull/42",
            ...
            JSON.stringify([
              {
                number: 7,
                title: "Merged work",
                url: "https://github.com/rhinehart514/croki/pull/7",
                baseRefName: "main",
