...
import { SourceControlProviderError, type ChangeRequest } from "@croki/contracts";
...
export const makeDiscovery = Effect.gen(function* () {
  ...
  return {
    ...
    label: "Bitbucket",
    installHint:
      "Set CROKI_BITBUCKET_EMAIL and CROKI_BITBUCKET_API_TOKEN on the server (use a Bitbucket API token with pull request, repository, and user read scopes).",
