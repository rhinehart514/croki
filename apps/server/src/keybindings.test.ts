import { KeybindingCommand, KeybindingRule, KeybindingsConfig } from "@croki/contracts";
...
import { KeybindingsConfigError } from "@croki/contracts";
...
it.layer(NodeServices.layer)("keybindings", (it) => {
  ...
  it.effect("ships configurable thread navigation defaults", () =>
    Effect.sync(() => {
      ...
      assert.equal(defaultsByCommand.get("canvas.open"), "mod+shift+c");
