...
import { makeKeyedCoalescingWorker } from "@croki/shared/KeyedCoalescingWorker";
...
>()("croki-server/terminal/Manager/TerminalManager") {}
...
function shouldExcludeTerminalEnvKey(key: string): boolean {
  ...
  if (normalizedKey.startsWith("CROKI_")) {
    return true;
  }
