import { readConnectAuthorizeRequest } from "@croki/shared/connectAuth";
...
const TEST_ENV = {
  CROKI_CLERK_PUBLISHABLE_KEY: "pk_test_Y2xlcmsuZXhhbXBsZS50ZXN0JA==",
  CROKI_CLERK_CLI_OAUTH_CLIENT_ID: "oauth_client_test",
  CROKI_HOSTED_APP_URL: "https://hosted.example.test",
};
