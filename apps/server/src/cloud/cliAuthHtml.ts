...
declare const __CROKI_BUILD_CHANNEL__: "nightly" | "latest" | undefined;

export function resolveLoopbackAuthorizationStage(): LoopbackAuthorizationStage {
  return typeof __CROKI_BUILD_CHANNEL__ === "undefined" ? "dev" : __CROKI_BUILD_CHANNEL__;
}
...
<html lang="en">
  <head>
    ...
    <title>Croki Connect authorization complete</title>
    <style>
      :root {
  ...
  <body>
    <main>
      ...
      <section class="content">
        ...
        <p class="description">Return to your terminal to finish setting up Croki Connect. You can close this window.</p>
      </section>
    </main>
  </body>
</html>`;
