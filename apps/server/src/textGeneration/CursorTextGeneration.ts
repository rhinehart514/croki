...
import { type CursorSettings, type ModelSelection } from "@croki/contracts";
import { sanitizeBranchFragment, sanitizeFeatureBranchName } from "@croki/shared/git";
import { extractJsonObject } from "@croki/shared/schemaJson";
  ...
  const runCursorJson = <S extends Schema.Top>({
    ...
    Effect.gen(function* () {
      ...
      const runtime = yield* makeCursorAcpRuntime({
        ...
        cwd,
        clientInfo: { name: "croki-git-text", version: "0.0.0" },
