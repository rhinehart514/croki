...
const requestLogPath = process.env.CROKI_ACP_REQUEST_LOG_PATH;
const exitLogPath = process.env.CROKI_ACP_EXIT_LOG_PATH;
const emitToolCalls = process.env.CROKI_ACP_EMIT_TOOL_CALLS === "1";
const emitInterleavedAssistantToolCalls =
  process.env.CROKI_ACP_EMIT_INTERLEAVED_ASSISTANT_TOOL_CALLS === "1";
const emitGenericToolPlaceholders = process.env.CROKI_ACP_EMIT_GENERIC_TOOL_PLACEHOLDERS === "1";
const emitAskQuestion = process.env.CROKI_ACP_EMIT_ASK_QUESTION === "1";
const emitXAiAskUserQuestion = process.env.CROKI_ACP_EMIT_XAI_ASK_USER_QUESTION === "1";
const emitXAiPromptCompleteThenHang =
  process.env.CROKI_ACP_EMIT_XAI_PROMPT_COMPLETE_THEN_HANG === "1";
const emitForeignSessionUpdates = process.env.CROKI_ACP_EMIT_FOREIGN_SESSION_UPDATES === "1";
const hangPromptForever = process.env.CROKI_ACP_HANG_PROMPT_FOREVER === "1";
const hangFirstPromptForever = process.env.CROKI_ACP_HANG_FIRST_PROMPT_FOREVER === "1";
const emitLateUpdateAfterCancel = process.env.CROKI_ACP_EMIT_LATE_UPDATE_AFTER_CANCEL === "1";
const omitXAiPromptCompleteStopReason =
  process.env.CROKI_ACP_OMIT_XAI_PROMPT_COMPLETE_STOP_REASON === "1";
const failLoadSession = process.env.CROKI_ACP_FAIL_LOAD_SESSION === "1";
const emitLoadReplay = process.env.CROKI_ACP_EMIT_LOAD_REPLAY === "1";
const hangLoadSessionAfterReplay = process.env.CROKI_ACP_HANG_LOAD_SESSION_AFTER_REPLAY === "1";
const delayLoadSessionAfterReplay = process.env.CROKI_ACP_DELAY_LOAD_SESSION_AFTER_REPLAY === "1";
const loadSessionDelayMs = Number(process.env.CROKI_ACP_LOAD_SESSION_DELAY_MS ?? "5000");
const emitStaleXAiPromptCompleteBeforeSecondHang =
  process.env.CROKI_ACP_EMIT_STALE_XAI_PROMPT_COMPLETE_BEFORE_SECOND_HANG === "1";
const emitOverlappingXAiPromptCompleteOutOfOrder =
  process.env.CROKI_ACP_EMIT_OVERLAPPING_XAI_PROMPT_COMPLETE_OUT_OF_ORDER === "1";
const failPrompt = process.env.CROKI_ACP_FAIL_PROMPT === "1";
const failSetConfigOption = process.env.CROKI_ACP_FAIL_SET_CONFIG_OPTION === "1";
const exitOnSetConfigOption = process.env.CROKI_ACP_EXIT_ON_SET_CONFIG_OPTION === "1";
const promptResponseText = process.env.CROKI_ACP_PROMPT_RESPONSE_TEXT;
const promptDelayMs = Number(process.env.CROKI_ACP_PROMPT_DELAY_MS ?? "0");
const permissionOptionIds = {
  allowOnce: process.env.CROKI_ACP_ALLOW_ONCE_OPTION_ID ?? "allow-once",
  allowAlways: process.env.CROKI_ACP_ALLOW_ALWAYS_OPTION_ID ?? "allow-always",
  rejectOnce: process.env.CROKI_ACP_REJECT_ONCE_OPTION_ID ?? "reject-once",
};
