...
function getGnomeKeyringRemediationMessage(): string {
  return "Croki could not access GNOME Keyring to save this environment credential. Install and start GNOME Keyring, then restart Croki.";
}

function getKWalletRemediationMessage(): string {
  return "Croki could not access KWallet to save this environment credential. Enable the KDE wallet subsystem in System Settings, then restart Croki.";
}
