...
>()("@croki/desktop/shell/DesktopShellEnvironment") {}
...
const startMarker = (name: string) => `__CROKI_ENV_${name}_START__`;
const endMarker = (name: string) => `__CROKI_ENV_${name}_END__`;
