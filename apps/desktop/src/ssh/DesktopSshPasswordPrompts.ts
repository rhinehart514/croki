import type { DesktopSshPasswordPromptRequest } from "@croki/contracts";
import { DesktopSshPasswordPromptResolutionInputSchema } from "@croki/contracts";
import type { SshPasswordRequest } from "@croki/ssh/auth";
...
export class DesktopSshPromptWindowUnavailableError extends Schema.TaggedErrorClass<DesktopSshPromptWindowUnavailableError>()(
  ...
  override get message(): string {
    ...
    return `Croki window is unavailable during ${this.stage} for SSH authentication to ${this.destination} (request: ${request}).`;
  }
}
...
>()("@croki/desktop/ssh/DesktopSshPasswordPrompts") {}
