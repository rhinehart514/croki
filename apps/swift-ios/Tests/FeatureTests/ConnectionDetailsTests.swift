...
struct ConnectionDetailsTests {
    ...
    @Test(arguments: [
        "croki://pair?pairingUrl=https%3A%2F%2Fremote.example.com%2Fpair%23token%3Dpairing-token",
        "croki-native://pair?pairingUrl=https%3A%2F%2Fremote.example.com%2Fpair%23token%3Dpairing-token",
    ...
    func mapsCancellationToUsefulCopy() {
        ...
        #expect(message.contains("Make sure Croki is running"))
    }
}
