...
public struct ConnectionOnboardingView: View {
    ...
    private var welcomeView: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 0) {
                ...
                Text("Connect securely to Croki running on your computer.")
                    .font(.body)
                ...
                VStack(spacing: 0) {
                    connectionAction(
                        ...
                        subtitle: "Copy it from Croki on your computer",
            ...
            VStack(alignment: .leading, spacing: 24) {
                VStack(alignment: .leading, spacing: 8) {
                    Text(entryHeading)
                        ...
                        .tracking(-0.6)
                    Text("Both values are shown in Croki when you create a mobile connection.")
                        .font(T3Typography.threadBody)
                        .foregroundStyle(T3Colors.textSecondary)
                }
    ...
    private var progressView: some View {
        VStack(alignment: .leading, spacing: 34) {
            ...
            Text(stage == .checking ? "Finding Croki" : "Connecting securely")
                .font(.largeTitle.bold())
                .tracking(-0.7)
            ...
            Text("Keep Croki open on your computer.")
                .font(T3Typography.supporting)
                .foregroundStyle(T3Colors.textSecondary)
        }
    ...
    private func pasteConnectionLink() {
        guard let value = UIPasteboard.general.string, !value.isEmpty else {
            entryHeading = "Connect manually"
            stage = .details
            errorMessage = "Copy a Croki pairing link first, or enter the details below."
    ...
    private func connect(_ action: ConnectionAction) {
        ...
        connectionTask = Task {
            ...
            case .localNetworkDenied:
                errorMessage = "Allow Local Network access so this iPhone can find Croki on your computer."
