...
struct T3RecentTasksWidget: Widget {
    ...
    var body: some WidgetConfiguration {
        ...
        .configurationDisplayName("Croki Tasks")
        .description("See active and recent Croki tasks at a glance.")
...
private enum T3WidgetURLs {
    static let newTask = URL(string: "croki-native://new-task")!
}
