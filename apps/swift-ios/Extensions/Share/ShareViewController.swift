...
struct T3ShareExtensionView: View {
    ...
    private var message: String {
        ...
        case let .saved(imageCount):
            imageCount == 0
                ? "Open Croki to choose a project and send it."
                : "Saved \(imageCount) image\(imageCount == 1 ? "" : "s"). Open Croki to choose a project."
