...
struct PlatformRecentThreadEntity: AppEntity {
    static let typeDisplayRepresentation = TypeDisplayRepresentation(name: "Croki Thread")
...
struct NewT3TaskIntent: AppIntent {
    static let title: LocalizedStringResource = "New Croki Task"
...
struct OpenRecentT3ThreadIntent: AppIntent {
    static let title: LocalizedStringResource = "Open Recent Croki Thread"
    static let description = IntentDescription("Open a recent thread in Croki.")
    static let openAppWhenRun = true
