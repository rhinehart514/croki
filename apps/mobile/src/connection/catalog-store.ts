...
import { ConnectionTransientError } from "@croki/client-runtime/connection";
...
export const CONNECTION_CATALOG_KEY = "croki.connection-catalog.v1";
export const LEGACY_CONNECTIONS_KEY = "croki.connections";
