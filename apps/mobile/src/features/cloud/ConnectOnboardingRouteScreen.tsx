...
import { reportAtomCommandResult, settlePromise } from "@croki/client-runtime/state/runtime";
...
/**
 * Post-sign-in onboarding sheet for Croki Connect. Mobile never publishes
 * environments itself — it consumes ones published elsewhere — so this simply
 * surfaces the account's Croki Connect environments right after sign-in so every
        ...
        {isSignedIn ? (
          ...
          <View collapsable={false} className="rounded-[24px] bg-card p-5">
            <Text className="text-sm leading-normal text-foreground-muted">
              Sign in to your Croki account to set up Croki Connect.
            </Text>
          </View>
        )}
