...
const BRAND_MARK_SOURCE = require("../../../../assets/croki/croki-mark-1024.png");
    ...
    <View className="flex-row items-center gap-3">
      ...
      <View className="gap-1">
        <View className="flex-row items-center gap-2">
          <Text className="text-lg font-t3-bold tracking-[-0.4px] text-foreground">Croki</Text>
        ...
        {!compact ? (
          <Text className="text-xs font-medium text-foreground-muted">
            Durable product context for your live coding environments
          </Text>
        ) : null}
      </View>
    </View>
