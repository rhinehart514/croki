...
public final class CrokiKeyboardCommandsModule: Module {
  public func definition() -> ModuleDefinition {
    Name("CrokiKeyboardCommands")

    View(CrokiKeyboardCommandsView.self) {
      Prop("enabledCommands") { (view: CrokiKeyboardCommandsView, commands: [String]) in
...
public final class CrokiKeyboardCommandsView: ExpoView {
