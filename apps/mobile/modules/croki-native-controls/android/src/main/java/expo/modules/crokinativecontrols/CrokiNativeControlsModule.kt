package expo.modules.crokinativecontrols

import expo.modules.kotlin.modules.Module
import expo.modules.kotlin.modules.ModuleDefinition

class CrokiNativeControlsModule : Module() {
  override fun definition() = ModuleDefinition {
    ...
    View(CrokiHeaderButtonView::class) {
      Prop("label") { view: CrokiHeaderButtonView, label: String ->
        view.setLabel(label)
      }
      Prop("systemImage") { view: CrokiHeaderButtonView, systemImage: String ->
