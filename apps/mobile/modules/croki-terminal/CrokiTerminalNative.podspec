...
Pod::Spec.new do |s|
  s.name = 'CrokiTerminalNative'
  s.version = package['version']
  s.summary = 'Native terminal surface for Croki mobile.'
  s.description = 'Native terminal surface bridge used by the Croki React Native app.'
