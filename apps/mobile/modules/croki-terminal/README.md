...
fork, with T3's iOS 16 compatibility patch applied. `CrokiTerminalView` owns a `libghostty` surface and
...
```bash
apps/mobile/modules/croki-terminal/scripts/build-libghostty-ios16.sh
```
...
```bash
apps/mobile/modules/croki-terminal/scripts/build-libghostty-android.sh
```
