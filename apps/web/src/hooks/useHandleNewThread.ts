...
import { DEFAULT_RUNTIME_MODE, type ScopedProjectRef, type ThreadId } from "@croki/contracts";
...
import { resolveDefaultThreadEnvMode } from "@croki/shared/threadEnvMode";
import { readThreadShell, useProjects, useThread } from "../state/entities";
import { resolveNewDraftStartFromOrigin } from "../lib/chatThreadActions";
import { readCrokiProjectFileDefaultThreadEnvMode } from "../lib/crokiProjectFileDefaults";
...
export function useNewThreadHandler() {
  ...
  return useCallback(
    (
      ...
      // The shared resolver owns the priority order. The croki.json read is
      ...
      const resolveDefaultEnvMode = async (): Promise<DraftThreadEnvMode> => {
        ...
        return resolveDefaultThreadEnvMode({
          ...
          projectFile: consultProjectFile
            ? await readCrokiProjectFileDefaultThreadEnvMode(
