import { DEFAULT_CLIENT_SETTINGS } from "@croki/contracts";
...
describe("clientPersistenceStorage", () => {
  ...
  it("reports structured decode failures while preserving the fallback", async () => {
    ...
    testWindow.localStorage.setItem("croki:client-settings:v1", "not-json");
    ...
    expect(consoleError).toHaveBeenCalledWith(
      ...
      expect.objectContaining({
        ...
        operation: "decode",
        storageKey: "croki:client-settings:v1",
