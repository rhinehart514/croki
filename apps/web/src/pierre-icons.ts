...
const PIERRE_ICON_SPRITE_ID = "croki-pierre-file-icon-sprite";

const CROKI_FILE_ICON_SPRITE = `
...
export const CROKI_PIERRE_ICONS = {
  set: "complete",
  colored: true,
  spriteSheet: CROKI_FILE_ICON_SPRITE,
  byFileName: {
...
const completeIconResolver = createFileTreeIconResolver(CROKI_PIERRE_ICONS);
...
export function ensurePierreIconSprite(): void {
  ...
  container.innerHTML = `${getBuiltInSpriteSheet("complete")}${CROKI_FILE_ICON_SPRITE}`;
