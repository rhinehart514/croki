...
import type { ChangeRequestStateLike } from "@croki/client-runtime/state/thread-settled";
...
interface ChatHeaderProps {
  ...
  onAddApplicationSource: (relativePath: string) => void;
    ...
    >
        ...
        {activeProjectName ? (
          <span className="inline-flex shrink-0 items-center gap-2">
            ...
            <CrokiApplicationFocus
              ...
              onAddSource={onAddApplicationSource}
      ...
      >
        {workerCount > 0 ? (
          ...
          >
            <SelectTrigger size="sm" aria-label="Worker presentation">
