    ...
    >
      <DialogPopup className="max-w-md" showCloseButton={false}>
        <DialogHeader>
          ...
          <DialogDescription>
            Croki needs your SSH password to connect to <code>{target}</code>. The password is
            passed to the local SSH process for this connection attempt and is not saved by Croki.
          </DialogDescription>
        </DialogHeader>
