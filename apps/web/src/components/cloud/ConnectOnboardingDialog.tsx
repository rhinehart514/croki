...
import { AuthAdministrativeScopes, AuthRelayWriteScope } from "@croki/contracts";
...
/**
 * Post-sign-in onboarding wizard for Croki Connect. Opens on every in-session
 ...
 * account's Croki Connect environments so every device can be connected right
  ...
  return (
    ...
    >
      <DialogPopup className="max-w-xl">
        <DialogHeader>
          <DialogTitle>Set up Croki Connect</DialogTitle>
          <DialogDescription>
    ...
    <div className="space-y-3">
      <div className="rounded-lg border">
        <OnboardingToggleRow
          ...
          description="Make this environment available to your other devices through Croki Connect."
