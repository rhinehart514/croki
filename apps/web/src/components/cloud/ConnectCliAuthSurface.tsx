...
const invalidLinkMessage = {
  ...
  description:
    "The link is missing its authorization request. Re-run `croki connect` in your terminal and open the freshly printed URL.",
} as const;
    ...
    return (
      <AuthSurfaceShell>
        <ConnectCliAuthMessage
          ...
          description="No authorization code was returned. Re-run `croki connect` in your terminal and try again."
        />
      </AuthSurfaceShell>
    );
  }
    ...
    return (
      <AuthSurfaceShell>
        <ConnectCliAuthMessage
          ...
          description="This authorization response does not match a connect request started in this browser. Re-run `croki connect` in your terminal and open the freshly printed URL in this browser."
        />
      </AuthSurfaceShell>
    );
  }
