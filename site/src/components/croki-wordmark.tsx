export function CrokiMark({ className }: { className?: string }) {
  return (
...
export function CrokiWordmark({ compact = false }: { compact?: boolean }) {
  return (
    <span className="wordmark" aria-label="Croki">
      <CrokiMark className="wordmark-mark" />
      {!compact && <span>Croki</span>}
    </span>
  );
}
