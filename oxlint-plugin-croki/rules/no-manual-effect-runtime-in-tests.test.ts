...
const rule = createOxlintRuleHarness("croki/no-manual-effect-runtime-in-tests", {
  filename: "fixture.test.ts",
});

describe("croki/no-manual-effect-runtime-in-tests", () => {
  rule.valid(
...
const productionRule = createOxlintRuleHarness("croki/no-manual-effect-runtime-in-tests");
