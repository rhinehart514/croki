import type { DesktopSshEnvironmentTarget, EnvironmentId } from "@croki/contracts";
import { resolveRemotePairingTarget } from "@croki/shared/remote";
...
>()("@croki/client-runtime/connection/onboarding/ConnectionOnboarding") {}
