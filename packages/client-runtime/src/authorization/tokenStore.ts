...
import { RelayManagedEndpoint } from "@croki/contracts/relay";
...
export class RemoteDpopAccessToken extends Schema.Class<RemoteDpopAccessToken>(
  "@croki/client-runtime/authorization/RemoteDpopAccessToken",
)({
...
>()("@croki/client-runtime/authorization/tokenStore/RemoteDpopAccessTokenStore") {}
