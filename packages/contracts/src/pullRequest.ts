...
> = {
  ...
  bitbucket: {
    missing:
      "Bitbucket needs API credentials on the server. Set CROKI_BITBUCKET_EMAIL and CROKI_BITBUCKET_API_TOKEN, or CROKI_BITBUCKET_ACCESS_TOKEN.",
    unauthenticated:
      "Bitbucket rejected the configured credentials. Check CROKI_BITBUCKET_EMAIL and CROKI_BITBUCKET_API_TOKEN.",
  },
};
