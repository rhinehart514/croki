...
import { CrokiProjectFile } from "./crokiProjectFile.ts";

const decode = Schema.decodeUnknownSync(CrokiProjectFile);

describe("CrokiProjectFile", () => {
  it("decodes a full project file", () => {
    const decoded = decode({
      $schema: "https://t3.codes/schema/croki.json",
