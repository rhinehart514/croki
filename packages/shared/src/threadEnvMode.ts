import type { ThreadEnvMode } from "@croki/contracts";

/**
 * Canonical priority order for a project's default thread env mode:
 * per-project setting > checked-in croki.json > global server setting.
 *
 ...
 * source that outranks croki.json decided, or the file read settled. While
