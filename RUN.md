# Drover outcome-first canvas run

> Resume contract: read this file, check `git status`, and continue from the first incomplete task. Preserve the starting dirty tree; do not reset or discard pre-existing work.
