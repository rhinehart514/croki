// Build-time stand-in for "shiki/wasm". Drover always runs shiki's JavaScript regex engine
...
export default function unavailableOnigurumaWasm(): never {
  throw new Error(
    "The Oniguruma WASM engine is not bundled. Drover highlights with shiki's JavaScript engine.",
  );
}
