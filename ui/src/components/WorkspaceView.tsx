    ...
    >
      <header className="wsv-head">
        <div className="wsv-head-title">
          ...
          <span className="wsv-head-sub">Every workflow, skill, and agent in this product</span>
        </div>
      ...
      <div className="wsv-lanes">
        ...
        <section className="wsv-lane">
          <div className="wsv-lane-head">
            <span className="wsv-lane-title"><Workflow size={13} /> Workflows</span>
            <span className="wsv-lane-count">{channels.length}</span>
            <button className="wsv-new" onClick={onNewWorkflow} type="button" title="Ideate a new workflow">
              <Plus size={13} />
            </button>
          </div>
          <div className="wsv-lane-body">
            {channels.length === 0 ? (
              <p className="wsv-empty">No workflows yet. Ideate one to start.</p>
            ) : (
