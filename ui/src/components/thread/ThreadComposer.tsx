...
export function ThreadComposer({ ventureId, ventureName, item, lens, draft, isHome, readOnly, readOnlyReason, onDriven }: {
  ventureId: string; ventureName: string; item: WorkIndexItem | null; lens: FirmLens | null; draft: boolean; isHome: boolean;
  readOnly: boolean; readOnlyReason: string | null; onDriven: () => void;
}) {
