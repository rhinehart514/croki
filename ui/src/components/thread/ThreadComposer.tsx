...
export function ThreadComposer({ ventureId, ventureName, item, lens, draft, isHome, readOnly, readOnlyReason, subjectRefs = [], scopeLabel, onDriven }: {
  ventureId: string; ventureName: string; item: WorkIndexItem | null; lens: FirmLens | null; draft: boolean; isHome: boolean;
  readOnly: boolean; readOnlyReason: string | null; subjectRefs?: string[]; scopeLabel?: string | null; onDriven: () => void;
}) {
