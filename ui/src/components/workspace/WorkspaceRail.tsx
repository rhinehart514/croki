...
export function WorkspaceRail({ venture, ventures, mode, width, search, selectedThread, workIndex, systemIndex, scope, selectedObjectRef, releaseIndex, selectedReleaseId, canStartRelease, onMode, onSearch, onSelectThread, onSelectObject, onScope, onSelectRelease, onNew, onStartRelease, onSwitchVenture, onResize, onSettings }: {
