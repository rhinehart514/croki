...
The tunnel fabric can later be Pipenet-derived, Tailscale-derived, or another reverse tunnel implementation. The rest of Croki should only see an `AdvertisedEndpoint`.
