> **Archived 2026-07-14.** These evals describe the superseded repository-change and GTM-engine
> products. They are evidence about earlier implementations, not acceptance criteria. The current
> contract is [FIRM-SPEC.md](../FIRM-SPEC.md), current proof is [STATE.md](../STATE.md), and current
> acceptance is [EVALS.md](../EVALS.md).
