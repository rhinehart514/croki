  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new Croki prerelease is available for nightly testers."
          : "A new Croki latest release is available.",
...
).pipe(Command.withDescription("Post a Croki release announcement to Discord."));
