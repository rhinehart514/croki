...
export function resolveShowcaseAndroidAbi(
  ...
  throw new Error(
    `Unsupported CROKI_SHOWCASE_ANDROID_ABI '${value}'. Use ${ANDROID_ABIS.join(", ")}.`,
  );
}
...
const config: ShowcaseConfig = {
  ...
  devices: [
    ...
    },
    {
      id: "iphone-6.5",
      platform: "ios",
      simulator: "Croki Showcase iPhone 14 Plus",
    ...
    },
    {
      ...
      abi: resolveShowcaseAndroidAbi(process.env.CROKI_SHOWCASE_ANDROID_ABI),
      appearance: "dark",
      theme: DEFAULT_SHOWCASE_THEME,
      viewport: {
        width: 1080,
