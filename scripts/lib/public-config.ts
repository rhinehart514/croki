...
export interface CrokiPublicConfig {
...
export function loadRepoEnv({
  ...
  return {
    ...
    ...(config.clerkPublishableKey
      ? {
          CROKI_CLERK_PUBLISHABLE_KEY: config.clerkPublishableKey,
    ...
    ...(config.clerkJwtTemplate
      ? {
          CROKI_CLERK_JWT_TEMPLATE: config.clerkJwtTemplate,
    ...
    ...(config.clerkCliOAuthClientId
      ? {
          CROKI_CLERK_CLI_OAUTH_CLIENT_ID: config.clerkCliOAuthClientId,
...
export function resolvePublicConfig(...sources: readonly Environment[]): CrokiPublicConfig {
  return {
