...
[`docs/FIRM-SPEC.md`](docs/FIRM-SPEC.md) defines durable product/build physics.
[`docs/STATE.md`](docs/STATE.md) records current proof. [`DESIGN.md`](DESIGN.md) defines the intended
desktop experience. This file is a compact translation and overrides none of them.
...
Every run begins with explicit founder direction or a founder-invoked workflow. A workflow is an outcome
contract: intended result, constraints, required artifacts, proof, checkpoints, and completion conditions.
Claude and Codex retain freedom over method within the direction's authority.
...
Drover keeps separate:

- what happened;
- the evidence proving it;
- what a founder or model believes it means;
- what action may follow.

Every Product claim cites repository truth or remains labeled inference. Market, telemetry, and revenue
...
5. Autonomy belongs to the direction, not an agent identity.
6. Facts, evidence, and interpretation remain distinct and visibly sourced.
7. Direct manipulation remains reversible until an act crosses into the world.
...
The shipped founder product is Electron desktop. The browser build is a development and deterministic-test
harness, not another production surface. Accessibility and visual behavior follow `DESIGN.md`.
